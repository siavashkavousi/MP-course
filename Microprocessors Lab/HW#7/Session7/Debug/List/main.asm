...
; 0000 003D 				PINB = 0xBF;
	LDI  R30,LOW(191)
	OUT  0x16,R30
; 0000 003E 			else if(!PINA.1)
	RJMP _0x18
_0x17:
	SBIC 0x19,1
	RJMP _0x19
; 0000 003F 				PORTB = 0x86;
	LDI  R30,LOW(134)
	RJMP _0x3B
; 0000 0040 			else if(!PINA.2)
_0x19:
	SBIC 0x19,2
	RJMP _0x1B
; 0000 0041 				PORTB = 0xDB;
	LDI  R30,LOW(219)
	RJMP _0x3B
; 0000 0042 			else if(!PINA.3)
_0x1B:
	SBIC 0x19,3
	RJMP _0x1D
; 0000 0043 				PORTB = 0xCF;
	LDI  R30,LOW(207)
_0x3B:
	OUT  0x18,R30
; 0000 0044 			break;
...
; 0000 0047 			if(!PINA.0)
	SBIC 0x19,0
	RJMP _0x1F
; 0000 0048 				PORTB = 0xE6;
	LDI  R30,LOW(230)
	RJMP _0x3C
; 0000 0049 			else if(!PINA.1)
_0x1F:
	SBIC 0x19,1
	RJMP _0x21
; 0000 004A 				PORTB = 0xED;
	LDI  R30,LOW(237)
	RJMP _0x3C
; 0000 004B 			else if(!PINA.2)
_0x21:
	SBIC 0x19,2
	RJMP _0x23
; 0000 004C 				PORTB = 0xFD;
	LDI  R30,LOW(253)
	RJMP _0x3C
; 0000 004D 			else if(!PINA.3)
_0x23:
	SBIC 0x19,3
	RJMP _0x25
; 0000 004E 				PORTB = 0x87;
	LDI  R30,LOW(135)
_0x3C:
	OUT  0x18,R30
; 0000 004F 			break;
...
; 0000 0052 			if(!PINA.0)
	SBIS 0x19,0
; 0000 0053 				PORTB = 0xFF;
	RJMP _0x3D
; 0000 0054 			else if(!PINA.1)
	SBIC 0x19,1
	RJMP _0x29
; 0000 0055 				PORTB = 0xE7;
	LDI  R30,LOW(231)
	RJMP _0x3E
; 0000 0056 			else if(!PINA.2)
_0x29:
	SBIC 0x19,2
	RJMP _0x2B
; 0000 0057 				PORTB = 0xF7;
	LDI  R30,LOW(247)
	RJMP _0x3E
; 0000 0058 			else if(!PINA.3)
_0x2B:
	SBIC 0x19,3
	RJMP _0x2D
...
; 0000 005D 			if(!PINA.0)
	SBIC 0x19,0
	RJMP _0x2F
; 0000 005E 				PORTB = 0xB9;
	LDI  R30,LOW(185)
	RJMP _0x3F
; 0000 005F 			else if(!PINA.1)
_0x2F:
	SBIC 0x19,1
	RJMP _0x31
; 0000 0060 				PORTB = 0xBF;
	LDI  R30,LOW(191)
	RJMP _0x3F
; 0000 0061 			else if(!PINA.2)
_0x31:
	SBIC 0x19,2
	RJMP _0x33
; 0000 0062 				PORTB = 0xF9;
	LDI  R30,LOW(249)
	RJMP _0x3F
; 0000 0063 			else if(!PINA.3)
_0x33:
	SBIC 0x19,3
	RJMP _0x35
; 0000 0064 				PORTB = 0xF1;
	LDI  R30,LOW(241)
_0x3F:
	OUT  0x18,R30
; 0000 0065 			break;
...
; 0000 0077 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(240)
	OUT  0x1A,R30
; 0000 0078 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0079 PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(255)
	OUT  0x1B,R30
; 0000 007A 
...
; 0000 007D DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	OUT  0x17,R30
; 0000 007E // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 007F PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	OUT  0x18,R30
; 0000 0080 
; 0000 0081 // Port C initialization
; 0000 0082 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0083 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(240)
	OUT  0x14,R30
; 0000 0084 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=1 Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0085 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (1<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(16)
	OUT  0x15,R30
; 0000 0086 
...
; 0000 00B2 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 00B3 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 00BC // INT1: Off
; 0000 00BD // INT2: Off
; 0000 00BE MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	OUT  0x35,R30
...
; 0000 00C3 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	OUT  0xA,R30
; 0000 00C4 
