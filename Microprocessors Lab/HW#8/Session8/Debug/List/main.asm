...
_0x0:
	.DB  0x73,0x69,0x61,0x76,0x61,0x73,0x68,0x0
...
; 0000 0042             if(!PINA.0)
	SBIC 0x19,0
	RJMP _0x17
; 0000 0043                 lcd_puts("0");
	__POINTW2MN _0x18,0
	RJMP _0x3D
; 0000 0044             else if(!PINA.1)
_0x17:
	SBIC 0x19,1
	RJMP _0x1A
; 0000 0045                 lcd_puts("1");
	__POINTW2MN _0x18,2
	RJMP _0x3D
...
_0x1A:
	SBIC 0x19,2
	RJMP _0x1C
; 0000 0047 				lcd_puts("2");
	__POINTW2MN _0x18,4
	RJMP _0x3D
; 0000 0048 			else if(!PINA.3)
_0x1C:
	SBIC 0x19,3
	RJMP _0x1E
; 0000 0049 				lcd_puts("3");
	__POINTW2MN _0x18,6
_0x3D:
	RCALL _lcd_puts
; 0000 004A 			break;
...
; 0000 004D 			if(!PINA.0)
	SBIC 0x19,0
	RJMP _0x20
; 0000 004E 				lcd_puts("4");
	__POINTW2MN _0x18,8
	RJMP _0x3E
; 0000 004F 			else if(!PINA.1)
_0x20:
	SBIC 0x19,1
	RJMP _0x22
; 0000 0050 				lcd_puts("5");
	...
	RJMP _0x3E
; 0000 0051 			else if(!PINA.2)
_0x22:
	SBIC 0x19,2
	RJMP _0x24
; 0000 0052 				lcd_puts("6");
	__POINTW2MN _0x18,12
	RJMP _0x3E
; 0000 0053 			else if(!PINA.3)
_0x24:
	SBIC 0x19,3
	RJMP _0x26
; 0000 0054 				lcd_puts("7");
...
; 0000 0058 			if(!PINA.0)
	SBIC 0x19,0
	RJMP _0x28
; 0000 0059 				lcd_puts("8");
	__POINTW2MN _0x18,16
	RJMP _0x3F
; 0000 005A 			else if(!PINA.1)
_0x28:
	SBIC 0x19,1
	RJMP _0x2A
; 0000 005B 				lcd_puts("9");
	__POINTW2MN _0x18,18
	RJMP _0x3F
; 0000 005C 			else if(!PINA.2)
_0x2A:
	SBIC 0x19,2
	RJMP _0x2C
; 0000 005D 				lcd_puts("A");
	__POINTW2MN _0x18,20
	RJMP _0x3F
; 0000 005E 			else if(!PINA.3)
_0x2C:
	SBIC 0x19,3
	RJMP _0x2E
; 0000 005F 				lcd_puts("B");
...
; 0000 0063 			if(!PINA.0)
	SBIC 0x19,0
	RJMP _0x30
; 0000 0064 				lcd_puts("C");
	__POINTW2MN _0x18,24
	RJMP _0x40
; 0000 0065 			else if(!PINA.1)
_0x30:
	SBIC 0x19,1
	RJMP _0x32
; 0000 0066 				lcd_puts("D");
	__POINTW2MN _0x18,26
	RJMP _0x40
; 0000 0067 			else if(!PINA.2)
_0x32:
	SBIC 0x19,2
	RJMP _0x34
; 0000 0068 				lcd_puts("E");
	__POINTW2MN _0x18,28
	RJMP _0x40
; 0000 0069 			else if(!PINA.3)
_0x34:
	SBIC 0x19,3
	RJMP _0x36
; 0000 006A 				lcd_puts("F");
	__POINTW2MN _0x18,30
_0x40:
	RCALL _lcd_puts
; 0000 006B 			break;
_0x36:
...
; 0000 007E DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(240)
	OUT  0x1A,R30
; 0000 007F // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0080 PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(255)
	OUT  0x1B,R30
; 0000 0081 
; 0000 0082 // Port B initialization
; 0000 0083 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0084 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(0)
	OUT  0x17,R30
...
; 0000 008A DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
...
; 0000 0090 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
...
; 0000 00C3 // INT1: Off
; 0000 00C4 // INT2: Off
; 0000 00C5 MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	OUT  0x35,R30
; 0000 00C6 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 00C7 
...
; 0000 00E4 // RS - PORTC Bit 3
; 0000 00E5 // RD - PORTD Bit 7
; 0000 00E6 // EN - PORTD Bit 6
; 0000 00E7 // D4 - PORTB Bit 4
; 0000 00E8 // D5 - PORTB Bit 5
; 0000 00E9 // D6 - PORTB Bit 6
; 0000 00EA // D7 - PORTB Bit 7
...
; 0000 00EE lcd_clear();
	RCALL _lcd_clear
; 0000 00EF lcd_puts("Hello World");
	__POINTW2MN _0x38,0
	RCALL _lcd_puts
; 0000 00F0 
