...
_0x0:
	.DB  0x69,0x6E,0x74,0x30,0x20,0x64,0x6F,0x6E
	.DB  0x65,0x0,0x69,0x6E,0x74,0x31,0x20,0x73
...
; 0000 0080     lcd_clear();
	RCALL _lcd_clear
; 0000 0081     for(i=0; i<15; i++)
	__GETWRN 16,17,0
_0x3D:
	__CPWRN 16,17,15
	BRGE _0x3E
; 0000 0082         lcd_putchar(data[i]);
	LDI  R26,LOW(_data)
	LDI  R27,HIGH(_data)
	ADD  R26,R16
	ADC  R27,R17
