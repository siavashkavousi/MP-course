...
; 0000 0033 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=In Bit0=In
; 0000 0034 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(12)
	OUT  0x17,R30
; 0000 0035 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=T Bit0=T
...
; 0000 0046 // Clock value: 0.977 kHz
; 0000 0047 // Mode: CTC top=OCR0
; 0000 0048 // OC0 output: Toggle on compare match
; 0000 0049 // Timer Period: 0.26214 s
; 0000 004A // Output Pulse(s):
; 0000 004B // OC0 Period: 0.52429 s Width: 0.26214 s
; 0000 004C TCCR0=(0<<WGM00) | (0<<COM01) | (1<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(29)
	OUT  0x33,R30
...
; 0000 0072 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(2)
	OUT  0x39,R30
; 0000 0073 
